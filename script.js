...
const items = [
    ...
    { name: "Ring of Quiet Mornings", 
        icon: "💍🌅", 
        description: "Wear this ring to quite the noise from kids and the world and most importantly, your mind.", 
        stats: "+4 Wis, +2 Con", 
        category: "DnD", 
        rarity: "Rare" },
    ...
    { name: "Cloak of Emotional Armor", 
        icon: "🧥🛡️", 
        description: "This armor allows you to feel your emotions safely and never wears out.", 
        stats: "+6 Con", 
        category: "DnD", 
        rarity: "Epic" },
    ...
    { name: "Boots of Getting Stuff Done", 
        icon: "🥾⚡", 
        description: "Get more work done today with these enchanted boots!", 
        stats: "+4 Dex, +2 Con", 
        category: "DnD", 
        rarity: "Uncommon" },
    ...
    { name: "Amulet of Self-Trust", 
        icon: "📿✨", 
        description: "Trust yourself even more today with this amulet.", 
        stats: "+5 Wis", 
        category: "DnD", 
        rarity: "Rare" },
    ...
    { name: "Helm of Clear Thoughts", 
        icon: "🪖💭", 
        description: "If your mind is clouded with too much, where this helm to calm it down.", 
        stats: "+6 Wis", 
        category: "DnD", 
        rarity: "Epic" },
