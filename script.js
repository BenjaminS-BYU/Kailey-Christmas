...
const items = [
    ...
    { name: "Unreal Vine Bracelet", 
        icon: "🌿📿", 
        description: "This magical bracelet allows the wearer to imdiently understand a new language that you choose for a day. Bhfuilis soranna sorcha Ach tagais 'nós na hoíche Trína chéile", 
        stats: "+5 Int, +6 Wis", 
        category: "Hozier", 
        rarity: "Epic" },
